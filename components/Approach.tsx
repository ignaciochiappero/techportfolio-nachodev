    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Colaboraremos para delinear los objetivos de tu sitio web, el público objetivo y las funcionalidades clave. Discutiremos aspectos como la estructura del sitio, la navegación y los requisitos de contenido."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Una vez que acordamos el plan, pongo mi playlist de lofi y me sumerjo en el código. Desde los bocetos iniciales hasta el código final, te mantengo actualizado en cada paso del proceso."
        >
          <CanvasRevealEffect
            animationSpeed={3}
